        ...
        <div
          className={`absolute inset-0 ${
            isDarkMode
              ...
              : "bg-linear-to-br from-white via-gray-100 to-white"
          }`}
        />
        <div
                ...
                <div className="mt-4">
                  {profile ? (
                    ...
                    <button
                      ...
                      } py-2.5 text-sm font-medium rounded-lg transition-all duration-300 flex items-center justify-center gap-2`}
                    >
